...
export function KeyFeaturesSection() {
  return (
    <section id="features" className="bg-white px-4 py-12 sm:px-6 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 2xl:max-w-[1800px]">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 sm:mt-12 sm:grid-cols-2 sm:gap-10 lg:mt-16 lg:grid-cols-3 lg:gap-12 xl:grid-cols-4 2xl:grid-cols-4 2xl:gap-16">
